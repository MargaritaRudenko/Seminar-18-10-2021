...
Для того, чтобы скачать все изменения из удаленного репозитория в локальный, используем команду *git pull*. Эта команда автоматически мерджит локальную и удаленную версии. Могут возникнуть конфликты.
